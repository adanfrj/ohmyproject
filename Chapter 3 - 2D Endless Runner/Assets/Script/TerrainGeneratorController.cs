...
public class TerrainGeneratorController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        lastRemovedPositionX = lastGeneratedPositionX - terrainTemplatesWidth;
    ...
    private void Update()
    {
        ...
        while (lastRemovedPositionX + terrainTemplatesWidth< GetHorizontalPositionStart())
        {
        RemoveTerrain(lastRemovedPositionX);
        lastRemovedPositionX += terrainTemplatesWidth;
        }
    }
